...
def confirm_close():
    return messagebox.askyesno(message="You have unsaved changes. Are you sure you want to close?", icon="question", title="Unsaved Changes")
...
def confirm_quit():
    ...
    for tab in notebook.tabs():
        ...
        if hash(content) != text_content[str(tab_widget)]:
            unsaved = True
            break
...
def show_about_info():
    messagebox.showinfo(title="About", message="Bianca's Text Editor is a simple tabbed text editor designed to help you learn Tkinter.")


root = tk.Tk()
root.title("Bianca's Text Editor")
